...
function persist(){try{save.meta.updatedAt=new Date().toISOString();save.meta.lastGameVersion='0.3.1';localStorage.setItem(SAVE_KEY,JSON.stringify(save));window.dispatchEvent(new CustomEvent('pocho:save-changed',{detail:{save:JSON.parse(JSON.stringify(save))}}))}catch{}}
